...
<excluded_findings>
- prompt-injection at app/agent/catalogo.py: linhas.append(f"- {p.nome} (`{p.id}`): cobre {', '.join(p.coberturas)}.") ... linhas.append( f"O {menor.nome} tem a meno
</excluded_findings>
